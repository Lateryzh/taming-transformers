...
import wandb  # 确保在 _wandb 函数调用前导入[3](@ref)
...
if __name__ == "__main__":
    ...
    if opt.resume:
        ...
        os.chmod(os.path.join(logdir,'wandb'), 0o777)  # 设置可写权限
    ...
    try:
        ...
        logger_cfg = OmegaConf.merge(default_logger_cfg, logger_cfg)  # 合并默认配置与用户配置
